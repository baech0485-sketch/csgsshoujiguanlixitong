...
export function ExchangeIcon(props: IconProps) { return <Icon {...props}><path d="M3.8 6.2h8.4" /><path d="m9.5 3.7 2.7 2.5-2.7 2.6" /><path d="M16.2 13.8H7.8" /><path d="m10.5 11.2-2.7 2.6 2.7 2.5" /></Icon>; }
